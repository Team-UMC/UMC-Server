...
public enum ProjectInfo {
    ...
    TEMBURIN("템버린", "일상생활에서 사용하고 있는 item의 교체 주기를 위한 알림을 제공하여 잊어버리지 않도록 도와주는 어플리케이션", "", List.of("알림", "교체", "생활용품"), Semester.FIFTH, List.of(ProjectType.AOS)),
    ...
    UMJUMISIKHOI("음주미식회", "사용자들에게 음식과 맞는 주종을 추천해주고 커뮤니티를 통해서 다른 사람의 베스트 조합을 볼 수 있고 이야기를 나눌 수 있는 어플리케이션", "", List.of("음식", "주류", "조합"), Semester.FIFTH, List.of(ProjectType.IOS)),
    ...
    // SQUARE
    JUINJANG("주인장", "내 손안의 완벽한 부동산 임장", "", List.of("생산성", "임장", "체크리스트"), Semester.FIFTH, List.of(ProjectType.IOS)),
    BLOOD_TRAIL("BloodTrail", "헌혈 원포인트 어플", "", List.of("헌혈", "커뮤니티"), Semester.FIFTH, List.of(ProjectType.WEB)),
    NANGMAN_CAT("낭만 고양이", "마음을 전달하는 모바일 편지 서비스", "", List.of("느린 우체통", "개성", "소통"), Semester.FIFTH, List.of(ProjectType.WEB)),
    UJU_JEONGGEOJANG("우주 정거장", "나를 위한 글쓰기", "", List.of("글쓰기", "몰입", "자기개발"),Semester.FIFTH, List.of(ProjectType.WEB)),
    HOMEAT("Homeat", "챌린지형 식비 관리 커뮤니티 어플", "", List.of("1인가구", "식비관리", "정보공유"), Semester.FIFTH, List.of(ProjectType.IOS)),
    FORGRAD("FORGRAD", "당신의 졸업을 위한 모든 것! 졸업정보서비스", "", List.of("졸업", "소통", "편리함"), Semester.FIFTH, List.of(ProjectType.AOS)),
    INTERPHONE("인터폰!", "자신에게 맞는 기업추천 서비스", "", List.of("인턴", "대학생", "스펙쌓기"), Semester.FIFTH, List.of(ProjectType.WEB)),
    DONGNEHYEONG("동네형", "당신 근처의 ‘동네형’에게 운동을 배우세요.", "", List.of("헬스", "PT"), Semester.FIFTH, List.of(ProjectType.WEB)),
    CAREER_FESTIVAL("Career Festival", "내 커리어에 맞는 오프라인 행사 매칭 및 기록 서비스", "", List.of("커리어", "자기개발", "행사"), Semester.FIFTH, List.of(ProjectType.WEB)),
    ...
    ANDDEUL("안뜰", "가족 중심 네트워킹 어플", "", List.of("따듯함", "일상공유", "마음전하기"), Semester.FIFTH, List.of(ProjectType.AOS)),
    AIRECIPE("아이레시피", "AI 챗봇 기반 맞춤형 레시피 서비스", "", List.of("친환경", "레시피", "간편함"), Semester.FIFTH, List.of(ProjectType.AOS)),
    BE_ILSANG("비일상", "친환경 실천을 위한 챌린지 및 커뮤니티 플랫폼 서비스", "", List.of("친환경", "챌린지"), Semester.FIFTH, List.of(ProjectType.IOS)),
    ...
    GONGJAKSO("공작소", "공모전/프로젝트 관련 공고를 확인하고 팀빌딩을 돕는 서비스, 공작소", "", List.of("팀 빌딩", "캘린더"), Semester.FIFTH, List.of(ProjectType.WEB)),
    // W
    ...
    DDODDOGA("또또가", "리뷰어와 상점을 연결하는 리뷰어 마케팅 중개 서비스", "", List.of("리뷰", "마케팅"), Semester.FIFTH, List.of(ProjectType.WEB)),
    CHOIAEEU_JANGSO("최애의 장소", "일본 애니메이션 성지순례 정보 제공 서비스", "", List.of("성지순례", "최애"), Semester.FIFTH, List.of(ProjectType.AOS)),
    BRUSHWORK("BRUSHWORK",  "미대생 졸업작품 판매 웹 서비스", "", List.of("미대생", "졸업작품", "채팅"), Semester.FIFTH, List.of(ProjectType.WEB)),
    PROUST("프루스트", "너의 취’향’을 찾고 싶어? ✨ -  향수 정보 커뮤니티 앱", "", List.of("커뮤니티", "감성", "편리함"), Semester.FIFTH, List.of(ProjectType.WEB)),
    OLREA("올래", "청춘은 바로 지금! 시니어를 위한 교육 매칭 서비스", "", List.of("시니어", "교육", "매칭"), Semester.FIFTH, List.of(ProjectType.WEB)),
    MART_ALL("마트올",  "동네마트 온라인 장보기", "", List.of("365", "멤버십", "소통"), Semester.FIFTH, List.of(ProjectType.AOS)),
    ...
    BAB_ZIP("밥zip", "실시간 캠퍼스 식당 정보 서비스", "", List.of("음식", "대학", "메이트"), Semester.FIFTH, List.of(ProjectType.WEB)),
    UMARK("umark", "대학생이 경험하고 느끼는 것을 담은 큐레이션 공간", "", List.of("대학생", "큐레이션", "북마크"), Semester.FIFTH, List.of(ProjectType.WEB)),
    // HEDGES
    TEACHER_FOR_BOSS("티쳐 포 보스", "자영업자 솔루션 서비스", "", List.of("자영업", "사장"), Semester.FIFTH, List.of(ProjectType.AOS)),
    ...
    A_WRITE("각사각", "당신의 감정을 사각사각, 국내 자기 성장 도우미 서비스", "", List.of("통합성", "간편함", "기록적인"), Semester.FIFTH, List.of(ProjectType.AOS)),
    SURVEY_MATE("썰매", "설문 조사 중개를 위한 C2C 서비스",  "", List.of("설문 조사", "신뢰", "앱테크"), Semester.FIFTH, List.of(ProjectType.WEB)),
    YOUNET("Younet", "유학생을 위한 네트워크", "", List.of("유학생", "네트워크", "연결고리"), Semester.FIFTH, List.of(ProjectType.IOS)),
    CUMO("쿠모", "세상의 모든 종이 쿠폰을 모아주는 서비스", "", List.of("짠테크", "간편함", "쿠폰"), Semester.FIFTH, List.of(ProjectType.AOS, ProjectType.WEB)),
    EASY_EXCEL("이지 엑셀", "슬기로운 엑셀사용을 위한 엑셀 함수/단축키 통합정리 서비스", "", List.of("편리함", "액셀", "단축키"), Semester.FIFTH, List.of(ProjectType.WEB)),
    BONGURI("봉우리", "봉사활동을 쉽고 재미있게! 봉사활동 통합 플랫폼 서비스, 봉우리입니다", "", List.of("봉사", "통합", "유입&지속"), Semester.FIFTH, List.of(ProjectType.AOS)),
    ...
    MUFFLER("머플러", "소비 목표 달성을 도와주는 가계부", "", List.of("세세한 계획", "내 일정에 따라 나누는 계획"), Semester.FIFTH, List.of(ProjectType.IOS)),
    PEER_RE("PEER:Re", "건강한 협력을 위한 “선택형” 동료평가 서비스, PEER : Re (피어리)", "", List.of("간편함", "선택형", "동료평가"),Semester.FIFTH, List.of(ProjectType.WEB)),
    TEAMMATE("팀메이트", "모든 생활 체육을 함께 즐길 메이트를 쉽게 매칭해주는 서비스!", "", List.of("매칭", "운동", "개인정보보호"), Semester.FIFTH, List.of(ProjectType.WEB)),
    BAB_CHINGU("밥 친구", "식사 상황별 콘텐츠 추천 서비스", "", List.of("콘텐츠", "추천", "개인화"), Semester.FIFTH, List.of(ProjectType.WEB)),
    // KSSS
    ABOUT_ME("AboutMe", "다양한 나, 다양한 관계의 시작", "", List.of("멀티프로필", "명함", "커스텀마이징"), Semester.FIFTH, List.of(ProjectType.AOS)),
    ...
    DAON("다온", "암환자들을 위한 하루 기록 서비스", "", List.of("암","마이데이터", "일기"), Semester.FIFTH, List.of(ProjectType.AOS)),
    THE_GOODS("The GOODs", "개인 판매자 대상 온라인 주문서 플랫폼", "", List.of("덕질", "굿즈", "오픈마켓"), Semester.FIFTH, List.of(ProjectType.WEB)),
    AVAV("아브아브", "얼음같은 사회를 녹여줄 레크레이션 종합 플랫폼 서비스 아브아브입니다!", "", List.of("레크레이션", "아이스브레이킹", "남녀노소"), Semester.FIFTH, List.of(ProjectType.WEB)),
    MEME("메메", "나만의 메이크업 메이트, 메메!", "", List.of("개인화", "매칭", "커뮤니티"), Semester.FIFTH, List.of(ProjectType.IOS)),
    BRANDOL("BRANDOL", "우리가 만들어가는 브랜드, BRANDOL - 브랜드 팬덤 커뮤니티 앱", "", List.of("브랜딩", "콘텐츠", "팬"), Semester.FIFTH, List.of(ProjectType.AOS)),
    ...
    NANEUN_JIBSA("나는 집사", "당신이 곁엔 항상 반려견이, 반려동물 입양과 커뮤니티", "", List.of("반려견", "입양", "I am 집사에요"), Semester.FIFTH, List.of(ProjectType.IOS)),
    ...
    GROW_UP("그로우업", "자기계발의 모든 것", "", List.of("갓생", "자기계발", "미라클모닝"), Semester.FIFTH, List.of(ProjectType.WEB)),
    LIVIEW("LIVIEW", "위치기반 일상기록 및 시각화 어플", "", List.of("자동일기 작성", "직관성", "기록"), Semester.FIFTH, List.of(ProjectType.WEB)),
    BOOK_SENTIMENT_LEAGUE("Book Sentiment League", "사용자들이 독후감(센티멘트)을 작성하고 공유하며 랭킹을 경쟁하는 플랫폼", "", List.of("독후감", "센티멘트", "랭킹"), Semester.FIFTH, List.of(ProjectType.WEB)),
    // CHEMI
    DDOKRIP("똑립", "사회초년생들의 똑! 부러지는 독립을 위한 정보 공유 커뮤니티 플랫폼", "", List.of("정보공유", "커뮤니티", "독립"), Semester.FIFTH, List.of(ProjectType.AOS)),
    DDUBUK("뚜벅", "뚜벅은 AR을 활용한 게이미피케이션 요소를 통해 걷기에 게임재미를 더한 플랫폼", "", List.of("걷기", "산책", "게임"), Semester.FIFTH, List.of(ProjectType.IOS)),
    JJIKJJIKI("찍찍이", "갤러리에서 다른 사진들과 소중한 추억 섞어 보관하지 말자!!!", "", List.of("네컷사진", "앨범", "추억"), Semester.FIFTH, List.of(ProjectType.IOS)),
    ...
    MOAMOA("모아모아", "상품을 모아 사람을 모아 당신의 합리적 소비를 돕기 위한 공동 구매 플랫폼", "", List.of("공동 구매", "합리적 소비", "이웃"), Semester.FIFTH, List.of(ProjectType.WEB)),
